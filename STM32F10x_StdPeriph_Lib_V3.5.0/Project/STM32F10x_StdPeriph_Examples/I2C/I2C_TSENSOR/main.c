...
int main(void)
{
  ...
  {    
    ...
    */
    ...
    LM75_WriteReg(LM75_REG_THYS, TEMPERATURE_THYS << 8);  /*31ЭC*/
    LM75_WriteReg(LM75_REG_TOS, TEMPERATURE_TOS << 8);   /*32ЭC*/
    ...
    LM75_Init();
      ...
      /* Calculate temperature digits in ЭC */
      ...
      if (TempValue > 256)
      {
        ...
        {
          /* Convert temperature ЭC to Fahrenheit */
          TempValueFahrenheit = abs (32 - ((9 * TempValueCelsius) / 5));
          
          /* Calculate temperature digits in ЭF */
